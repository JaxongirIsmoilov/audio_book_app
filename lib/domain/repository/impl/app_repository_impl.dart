import 'package:audio_book_app/data/models/auth_data.dart';
import 'package:audio_book_app/data/models/book_data.dart';
import 'package:audio_book_app/domain/repository/app_repository.dart';
...
class AppRepositoryImpl extends AppRepository {
  ...
  Future<List<BookData>> searchBooksByName(String title) async {
    try {
      ...
      print("Error searchBooksByName: ${e.toString()}");
      return [];
    }
  }
}
